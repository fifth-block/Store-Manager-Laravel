...
@section('body')
	<div class="section-header">
		<h2><i class="fa fa-bar-chart-o"></i> Report<small>Range<small></h2>
		...
		{{Form::open(array("method" => "get", "class"=>"form-inline"))}}
			<div class="col-md-3">
			{{Bootstrap::date("fromDate", "From")}}
			</div>
			<div class="col-md-3">
			{{Bootstrap::date("toDate", "To")}}
			</div>
			<div class="col-md-6">
	...
	<div class="listWrapper">
		...
		<h2>From {{date("D, d M, Y",strtotime($fromDate))}} <br> To {{date("D, d M, Y",strtotime($toDate))}}</h2>
